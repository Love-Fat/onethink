...
(function() {
  ...
  $image_holder = $('<div id="jquery-fullsizable"><div id="fullsized_image_holder"></div><Div id="fullsized_title"><span></span></div></div>');
  ...
  showImage = function(image, direction, shouldHideChrome) {
    ...
    if (image.loaded != null) {
	  ...
	  $('#fullsized_title span').html(image.buffer_title);
  ...
  makeFullsizable = function() {
    ...
    return $(options.selector).each(function() {
	  ...
	  image.buffer_title = $(this).attr('title');
