...
class DocumentModel extends Model{
    ...
    protected $_validate = array(
        ...
        array('description', '1,1040', '简介长度不能超过1040个字符', self::VALUE_VALIDATE, 'length', self::MODEL_BOTH),
    ...
    protected $_auto = array(
		...
		array('description', 'getDescription', self::MODEL_INSERT, 'callback'),
		...
		array('meet_time', 'strtotime', self::MODEL_BOTH, 'function'),
    ...
    public function update($data = null){
    	...
    	$res = $this->checkDocumentType(2, I('pid') );
...
protected function getDescription()
{
	...
	{
		return msubstr(strip_tags($content),0,120);
	}
}
    ...
    protected function getStatus(){
        ...
        if(empty($id)){	//新增
			...
			$check = M('Category')->field('check')->where("id=".$cate)->find();
