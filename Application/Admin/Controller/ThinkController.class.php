...
class ThinkController extends AdminController {
    ...
    public function lists($model = null, $p = 0){
        ...
        $this->display($model['template_list']? 'Think/'.$model['template_list']:'Think/lists');
    ...
    public function edit($model = null, $id = 0){
        ...
        if(IS_POST){
            ...
            $this->display($model['template_edit']?'Think/'.$model['template_edit']:'Think/edit');
    ...
    public function add($model = null){
        ...
        if(IS_POST){
            ...
            $this->display($model['template_add']?'Think/'.$model['template_add']:'Think/add');
